/**
This Square.java class is a basic shape class wherein a square shape
is set up for visual drawing. This class implements the DrawingObject
interface and defines its draw(Graphics g2d) method to produce a square.
...
public class Square extends UniversalStyles implements DrawingObject {
    /* Required Fields */
    double x1 = 0;
    double y1 = 0;
    double s = 0;
     ...
     * a square that is visible, given that this shape's fields are initialized prior.
     */
    public void draw(Graphics2D g2d) {
        Rectangle2D.Double square = new Rectangle2D.Double(x1,y1,s,s);
        g2d.translate(tx, ty);
        g2d.rotate(theta);
    ...
    /* This is a mutator method to set up the Square shape's tx and ty fields before calling
    ...
    /* This is a mutator method to set up the Square shape's rotate field before calling
    ...
    public void rotate(double t) {
     ...
     /* This is a mutator method to set up the Square shape's fillColor field before calling
        the draw(Graphicsg2d) method on this class. It modifies the argument
    ...
    /* This is a mutator method to set up the Square shape's strokeColor field before calling
        the draw(Graphicsg2d) method on this class. It modifies the argument
    ...
    /* This is a mutator method to set up the Square shape's stroke field before calling
        the draw(Graphicsg2d) method on this class. It modifies the argument
    ...
    /* This is a mutator method to set up the Square shape's s field before calling the
        draw(Graphicsg2d) method on this class. Essentially, this method resizes the
        square and passes through double a as the square's size. 
     */
